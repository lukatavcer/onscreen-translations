export default {
    signIn: "SIGN IN",
    weSorryThisLinkIsExpired: "We're sorry, this link is expired",
    loading: "Loading...",
    newUser: "New users",
    ...
    decline: "DECLINE",
    checkingYourSpark: "Checking for Spark...",
    ...
    inviteAUserToThisSpark: "Invite a User to this Spark",
    resetSpark: "Reset Spark",
    ...
    deleteAccountDescription:
        "Deleting your account will delete all of you data on the platform including all your personal details, call history, saved Spark Devices, etc.",
    ...
    finallyWhatHDMIPort:
        "Finally, what HDMI port is the ONSCREEN Spark pluggedinto?",
    thisIsTheHDMIPortThatYouPlugged:
        "This is the HDMI port that you plugged your new device into",
    selectYourSparkPort: "Select your Spark port",
    letTestSwitchingToYourSpark: "Let's test switching to your Spark:",
    trySwitchingToSpark: "Try Switching to Spark",
    finish: "Finish",
    weMakeItEasyForYourSparkAndTVToWorkTogether:
        "We make it easy for your Spark and TV to work together.",
    ...
    learnAboutTheSpark: "Learn about the Spark",
    usingAppForCallsSinceYouDontHaveASpark:
        "Using App for calls, since you don't have a Spark.",
    familyShare: "Family Share",
    youCanShareYourSparkDeviceWithAnotherHousehold:
        "You can share your Spark Device with another household member. Simply invite them by providing their email address below.",
    invite: "Invite",
    waiting: "- Waiting",
    accepted: "- Accepted",
    ...
    setUpONSCREENSpark: "Set up ONSCREEN Spark",
    ...
    thisIsTheRightPathWhenSettingUpANewSpark:
        "This is the right path when setting up a new Spark device for yourselfto be able to make and receive video calls on your TV.  If you're trying to set up the Spark for someone else, like a senior in your family, please use the Caregiver Tab.",
    importantPleaseMakeSureYouHaveTheCorrect:
        " Important: Please make sure you have the correct WiFi information available.",
    startSetup: "Start Setup",
    haventSetUpTheSparkHardwareYet: "Haven't set up the Spark hardware yet?",
    tapHereForInstructions: "Tap here for instructions.",
    letsConnectYourONSCREENSparkToYourWiFiNetwork:
        "Let's connect your ONSCREEN Spark to your WiFi network.",
    ...
    yourNewUserIsReadyToGoLetsConnect:
        "Your new user is ready to go.  Let's connect them to the new Spark",
    readyToSetUpASparkForSomeoneElse:
        "Ready to set up a Spark for someone else?",
    ...
    zoomRequiresUsingASparkPlease:
        "Zoom requires using a Spark. Please select one from the Home screen.",
    dontHaveASparkEnjoyYourZoom:
        "Don't have a Spark? Enjoy your Zoom calls and meetings on your TV.",
    ...
    notAdequateForVideoCalls:
        "Not adequate for video calls.  Please move the Spark closer to your wifi router, or move the router closer to the Spark.",
    ...
    sorryYouCantCallYourself:
        "Sorry, you can't call yourself.  Nice try though.",
    ...
    yourSparkIsConnected: "Your Spark is connected!",
    holdThisUpToThe: "Hold this up to the",
    camera: "camera!",
    sparkIsOffline: "Spark is Offline",
    sparkGuestUser: "Spark - Guest User",
    nameWithValue: "Name: {{name}}",
    editDeviceName: "Edit Device Name",
    enterAEasilyRecognizable:
        "Enter a easily recognizable name for your Spark Device, like 'Living Room' or 'Bedroom'.",
    wifiNetworkNameSSID: "Wifi Network Name: {{SSID}}",
    signalStrengthDeviceSignal:
        "Signal Strength: {{deviceSignalStrengthNum}}dB",
    signalQualityDeviceSignalStrength:
        "Signal Quality: {{deviceSignalStrength}}",
    pingDevicePing: "Ping: {{devicePing}} ms",
    lastHeartbeatLastCheckIn: "Last Heartbeat: {{lastCheckIn}}",
    sparkVersionDeviceVersion: "Spark Version: {{deviceVersion}}",
    ...
    yourSparkWifiSignal: "Your Spark wifi signal is too weak for a call.",
    becauseOfYourWifiConnectionStrength:
        "Because of your wifi connection strength, you will not be able to have a good video call experience.  Please try moving your router closer to the Spark device, or remove anything that might be blocking the wifi signal.\n\nVisit our Help section for more information.",
    yourSparkWifiSignalIsALittleWeak:
        "Your Spark wifi signal is a little weak.",
    yourWifiConnectionStrengthIsWeak:
        "Your wifi connection strength is weak, and may impact the quality of your video calls.  Please try moving your router closer to the Spark device, or remove anything that might be blocking the wifi signal.\n\nVisit our Help section for more information.",
    ...
    didTheTVSwitchToTheSpark: "Did the TV switch to the Spark?",
    ...
    weCurrentlyDontSupportSwitching:
        "We currently don't support switching to non-HDMI ports, so you will need to manually switch back to your Tuner or Antenna after Spark calls using your TV remote.",
    ohNo: "Oh no!",
    ...
    haventSetUpTheSparkHardwareYetInstruction:
        "Haven't set up the Spark hardware yet?{'\n'}Tap here for instructions.",
    pleaseEnterYourWiFi: "Please enter your WiFi name",
    yourCurrentNetwork5Ghz:
        "Your current network seems to be a 5Ghz network which won't work with the Spark.  Please choose a different network on your phone, or type it in manually.",
    ...
    enablesSparkAutomatically:
        "Enables the Spark to automatically answer calls from your Favorites, after a 30 second delay.",
    ...
    allowContactsDescription:
        "Without allowing this permissions, you will not be able to make calls.  Please go to Settings and enable the permission.\n\nDo you want to go to Settings now?",
